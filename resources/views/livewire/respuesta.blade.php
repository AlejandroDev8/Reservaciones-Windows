<div class="md:w-1/2 space-y-5">
  ...
  <div>
    ...
    <x-text-input id="fecha_fin" class="block mt-1 w-full" type="date" wire:model="fecha_fin" :value="old('fecha_fin')"
  ...
  <div>
    <form wire:submit.prevent="aceptarSolicitud({{ $reservacion->id }})">
      <div>
